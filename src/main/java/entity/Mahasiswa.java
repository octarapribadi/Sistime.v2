...
public class Mahasiswa implements java.io.Serializable {
    ...
    public Mahasiswa(Agama agama, Kampus kampus, ProgramStudi programStudi, Sekolah sekolah, Status status, WaktuKuliah waktuKuliah, String email, Date tanggalPendaftaran, String namaMahasiswa, String tempatLahir, Date tanggalLahir, String alamatMahasiswa, String jenisKelamin, String alamatOrangtua, Integer anakKe, String golonganDarah, String hobi, Integer jumlahSaudara, String jurusan, String keterangan, String kewarganegaraan, String namaAyah, String namaIbu, String noIjazah, String noTeleponMahasiswa, String noTeleponOrangtua, String pekerjaanOrangtua, Integer tahunAngkatan, Integer tahunLulus, Date tanggalIjazah, String pendidikanOrangtua, Set<MahasiswaFile> mahasiswaFiles, User user) {
        ...
        this.mahasiswaFiles = mahasiswaFiles;
        this.user = user;
    }
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "mahasiswa", cascade = CascadeType.PERSIST)
    public Set<MahasiswaFile> getMahasiswaFiles() {
        return this.mahasiswaFiles;
    }

    public void setMahasiswaFiles(Set<MahasiswaFile> mahasiswaFiles) {
        this.mahasiswaFiles = mahasiswaFiles;
    }
}
